...
def ExtractSamples(mat, this_corefile, targyears, baseyear):
    ...
    Parameters:
        mat (dict): Loaded MATLAB .mat data.
        this_corefile (str): Key for the scenario in the .mat file.
        targyears (array): Target years for projections.
        baseyear (int): Reference year for projections.

    Returns:
        tuple: (wais_samps, eais_samps, gis_samps) arrays for the scenario.
    """
