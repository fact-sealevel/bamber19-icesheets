...
def bamber19_preprocess_icesheets(pyear_start:int, 
								  pyear_end:int, 
								  pyear_step:int, 
								  baseyear:int, 
								  scenario:str, 
								  ...
								  #core_file_h : str = 'corefileH',
								  #core_file_l : str = 'corefileL',
								  scenario_map:dict,
								  climate_data_file = '')-> dict:
...
def OutputDataScen(pipeline_id, eais_samps, wais_samps, gis_samps, scenario, targyears, baseyear):
...
def OutputDataAll(pipeline_id, eais_sampsH, wais_sampsH, gis_sampsH,  eais_sampsL, wais_sampsL, gis_sampsL, scenario, targyears, baseyear)-> dict:
